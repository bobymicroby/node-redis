...
export class CacheStats {
  ...
  */
  ...
  plus(other: CacheStats): CacheStats {
    return CacheStats.of(
      this.saturatedAdd(this.hitCount, other.hitCount),
      this.saturatedAdd(this.missCount, other.missCount),
      this.saturatedAdd(this.loadSuccessCount, other.loadSuccessCount),
      this.saturatedAdd(this.loadFailureCount, other.loadFailureCount),
      this.saturatedAdd(this.totalLoadTime, other.totalLoadTime),
      this.saturatedAdd(this.evictionCount, other.evictionCount)
    );
  }

  /**
   * Returns the sum of two numbers, capped at Number.MAX_SAFE_INTEGER to prevent overflow.
   *
   * @param a - First number
   * @param b - Second number
   * @returns Sum of a and b, capped at Number.MAX_SAFE_INTEGER
   */
  private saturatedAdd(a: number, b: number): number {
    const sum = a + b;
